...
date: 2019-10-01 10:36:28 -0400
categories: 1) Html&Css
---

해당 내용들은 인프런에서 듣는 '코알못에서 웹서비스 런칭까지 : 제주 코딩 베이스캠프' 강의에서 학습한 내용들을 복습한 것이다.<br />
...
-절대경로: 주소 http~~ 가 통째로 들어간 것.<br> -상대경로: 나를 기준으로 폴더와 파일의 위치를 쓰는 것.<br><br>
